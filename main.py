...
pygame.font.init()
display = Display()
default_font = font = pygame.font.SysFont("Arial Bold", 55)
...
def setup():
    is_setup = True
    setup_nbr_manager = pygame_textinput.TextInputManager(validator=lambda inp: len(inp) < 2 and (inp.isnumeric() or inp == "KEY_BACKSPACE"))
